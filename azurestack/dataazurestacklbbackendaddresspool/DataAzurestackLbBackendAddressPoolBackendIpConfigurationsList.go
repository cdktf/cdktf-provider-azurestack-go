...
func (d *jsiiProxy_DataAzurestackLbBackendAddressPoolBackendIpConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
