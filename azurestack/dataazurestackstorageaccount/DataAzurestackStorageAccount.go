...
func (j *jsiiProxy_DataAzurestackStorageAccount) Count() interface{} {
...
func (j *jsiiProxy_DataAzurestackStorageAccount)SetCount(val interface{}) {
...
func DataAzurestackStorageAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurestackStorageAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAzurestackStorageAccount_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurestackStorageAccount_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurestackStorageAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurestackStorageAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurestackStorageAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurestackStorageAccount) ToHclTerraform() interface{} {
	var returns interface{}
