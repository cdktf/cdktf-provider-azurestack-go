...
import (
	...
	"github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v8/publicip/internal"
...
type PublicIp interface {
	...
	SetPublicIpAddressAllocation(val *string)
	PublicIpAddressAllocationInput() *string
	// Experimental.
	...
	ResetPublicIpAddressAllocation()
	ResetReverseFqdn()
	ResetSku()
	ResetTags()
	ResetTimeouts()
...
func (j *jsiiProxy_PublicIp) PublicIpAddressAllocation() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PublicIp) PublicIpAddressAllocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicIpAddressAllocationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_PublicIp)SetPublicIpAddressAllocation(val *string) {
	if err := j.validateSetPublicIpAddressAllocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (p *jsiiProxy_PublicIp) ResetAllocationMethod() {
	_jsii_.InvokeVoid(
		p,
		"resetAllocationMethod",
		nil, // no parameters
...
func (p *jsiiProxy_PublicIp) ResetPublicIpAddressAllocation() {
	_jsii_.InvokeVoid(
		p,
		"resetPublicIpAddressAllocation",
		nil, // no parameters
