...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicIpAddressAllocation", GoGetter: "PublicIpAddressAllocation"},
			_jsii_.MemberProperty{JsiiProperty: "publicIpAddressAllocationInput", GoGetter: "PublicIpAddressAllocationInput"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllocationMethod", GoMethod: "ResetAllocationMethod"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublicIpAddressAllocation", GoMethod: "ResetPublicIpAddressAllocation"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.publicIp.PublicIpConfig",
		reflect.TypeOf((*PublicIpConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.publicIp.PublicIpTimeouts",
		reflect.TypeOf((*PublicIpTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.publicIp.PublicIpTimeoutsOutputReference",
