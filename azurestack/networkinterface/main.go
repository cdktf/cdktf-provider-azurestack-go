...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.networkInterface.NetworkInterfaceConfig",
		reflect.TypeOf((*NetworkInterfaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.networkInterface.NetworkInterfaceIpConfiguration",
		reflect.TypeOf((*NetworkInterfaceIpConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.networkInterface.NetworkInterfaceIpConfigurationList",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.networkInterface.NetworkInterfaceTimeouts",
		reflect.TypeOf((*NetworkInterfaceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.networkInterface.NetworkInterfaceTimeoutsOutputReference",
