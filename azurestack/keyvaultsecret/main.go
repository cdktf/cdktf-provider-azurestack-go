...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.keyVaultSecret.KeyVaultSecret",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.keyVaultSecret.KeyVaultSecretConfig",
		reflect.TypeOf((*KeyVaultSecretConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.keyVaultSecret.KeyVaultSecretTimeouts",
		reflect.TypeOf((*KeyVaultSecretTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.keyVaultSecret.KeyVaultSecretTimeoutsOutputReference",
