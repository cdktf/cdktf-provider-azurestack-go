...
import (
	...
	"github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v8/storageblob/internal"
...
func NewStorageBlobTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageBlobTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-azurestack.storageBlob.StorageBlobTimeoutsOutputReference",
