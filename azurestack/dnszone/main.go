...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsZone.DnsZone",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsZone.DnsZoneConfig",
		reflect.TypeOf((*DnsZoneConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsZone.DnsZoneSoaRecord",
		reflect.TypeOf((*DnsZoneSoaRecord)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsZone.DnsZoneSoaRecordOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsZone.DnsZoneTimeouts",
		reflect.TypeOf((*DnsZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsZone.DnsZoneTimeoutsOutputReference",
