...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordConfig",
		reflect.TypeOf((*DnsSrvRecordConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordRecord",
		reflect.TypeOf((*DnsSrvRecordRecord)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordRecordList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordRecordOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordTimeouts",
		reflect.TypeOf((*DnsSrvRecordTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dnsSrvRecord.DnsSrvRecordTimeoutsOutputReference",
