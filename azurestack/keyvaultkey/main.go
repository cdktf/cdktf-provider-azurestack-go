...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.keyVaultKey.KeyVaultKey",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.keyVaultKey.KeyVaultKeyConfig",
		reflect.TypeOf((*KeyVaultKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.keyVaultKey.KeyVaultKeyTimeouts",
		reflect.TypeOf((*KeyVaultKeyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.keyVaultKey.KeyVaultKeyTimeoutsOutputReference",
