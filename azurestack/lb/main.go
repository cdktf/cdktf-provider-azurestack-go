...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lb.Lb",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.lb.LbConfig",
		reflect.TypeOf((*LbConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.lb.LbFrontendIpConfiguration",
		reflect.TypeOf((*LbFrontendIpConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lb.LbFrontendIpConfigurationList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lb.LbFrontendIpConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.lb.LbTimeouts",
		reflect.TypeOf((*LbTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lb.LbTimeoutsOutputReference",
