...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAzurestackLbRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleConfig",
		reflect.TypeOf((*DataAzurestackLbRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleTimeouts",
		reflect.TypeOf((*DataAzurestackLbRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleTimeoutsOutputReference",
		reflect.TypeOf((*DataAzurestackLbRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
