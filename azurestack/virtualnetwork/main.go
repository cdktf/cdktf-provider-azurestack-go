...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetwork",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetworkConfig",
		reflect.TypeOf((*VirtualNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetworkSubnet",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetworkSubnetOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetworkTimeouts",
		reflect.TypeOf((*VirtualNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.virtualNetwork.VirtualNetworkTimeoutsOutputReference",
