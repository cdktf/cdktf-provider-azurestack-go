...
func (j *jsiiProxy_ManagedDisk) Encryption() ManagedDiskEncryptionOutputReference {
	var returns ManagedDiskEncryptionOutputReference
	_jsii_.Get(
		j,
		"encryption",
		&returns,
...
func (j *jsiiProxy_ManagedDisk) EncryptionInput() *ManagedDiskEncryption {
...
func (m *jsiiProxy_ManagedDisk) PutEncryption(value *ManagedDiskEncryption) {
...
func (m *jsiiProxy_ManagedDisk) ResetEncryption() {
	_jsii_.InvokeVoid(
		m,
		"resetEncryption",
		nil, // no parameters
