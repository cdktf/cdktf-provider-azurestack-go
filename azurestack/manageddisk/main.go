...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.managedDisk.ManagedDisk",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskConfig",
		reflect.TypeOf((*ManagedDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskEncryption",
		reflect.TypeOf((*ManagedDiskEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskEncryptionDiskEncryptionKey",
		reflect.TypeOf((*ManagedDiskEncryptionDiskEncryptionKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskEncryptionDiskEncryptionKeyOutputReference",
		reflect.TypeOf((*ManagedDiskEncryptionDiskEncryptionKeyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskEncryptionKeyEncryptionKey",
		reflect.TypeOf((*ManagedDiskEncryptionKeyEncryptionKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskEncryptionKeyEncryptionKeyOutputReference",
		reflect.TypeOf((*ManagedDiskEncryptionKeyEncryptionKeyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ManagedDiskEncryptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskTimeouts",
		reflect.TypeOf((*ManagedDiskTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.managedDisk.ManagedDiskTimeoutsOutputReference",
