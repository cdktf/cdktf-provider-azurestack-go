...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lbNatPool.LbNatPool",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.lbNatPool.LbNatPoolConfig",
		reflect.TypeOf((*LbNatPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.lbNatPool.LbNatPoolTimeouts",
		reflect.TypeOf((*LbNatPoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.lbNatPool.LbNatPoolTimeoutsOutputReference",
