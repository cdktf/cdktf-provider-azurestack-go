...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.availabilitySet.AvailabilitySet",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.availabilitySet.AvailabilitySetConfig",
		reflect.TypeOf((*AvailabilitySetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.availabilitySet.AvailabilitySetTimeouts",
		reflect.TypeOf((*AvailabilitySetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.availabilitySet.AvailabilitySetTimeoutsOutputReference",
