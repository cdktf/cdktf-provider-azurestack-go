...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.virtualMachineExtension.VirtualMachineExtension",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.virtualMachineExtension.VirtualMachineExtensionConfig",
		reflect.TypeOf((*VirtualMachineExtensionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurestack.virtualMachineExtension.VirtualMachineExtensionTimeouts",
		reflect.TypeOf((*VirtualMachineExtensionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurestack.virtualMachineExtension.VirtualMachineExtensionTimeoutsOutputReference",
