...
func (d *jsiiProxy_DataAzurestackVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
