...
func (d *jsiiProxy_DataAzurestackVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
