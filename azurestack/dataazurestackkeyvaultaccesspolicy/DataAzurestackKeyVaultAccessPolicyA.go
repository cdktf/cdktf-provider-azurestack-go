...
func (j *jsiiProxy_DataAzurestackKeyVaultAccessPolicyA) Count() interface{} {
...
func (j *jsiiProxy_DataAzurestackKeyVaultAccessPolicyA)SetCount(val interface{}) {
...
func DataAzurestackKeyVaultAccessPolicyA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurestackKeyVaultAccessPolicyA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAzurestackKeyVaultAccessPolicyA_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurestackKeyVaultAccessPolicyA_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurestackKeyVaultAccessPolicyA_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurestackKeyVaultAccessPolicyA_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurestackKeyVaultAccessPolicyA) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurestackKeyVaultAccessPolicyA) ToHclTerraform() interface{} {
	var returns interface{}
