...
type DataAzurestackVirtualNetworkGatewayConnectionConfig struct {
	// Experimental.
	...
	Timeouts *DataAzurestackVirtualNetworkGatewayConnectionTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
