...
func (d *jsiiProxy_DataAzurestackVirtualNetworkGatewayConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurestackVirtualNetworkGatewayConnection) ToHclTerraform() interface{} {
	var returns interface{}
